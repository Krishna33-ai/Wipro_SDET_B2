...
addEmp({ id: 10, name: "siva", role: Role.User });
addEmp({ id: "xyz", name: "Ameen", role: Role.User });
addEmp({ id: 20, name: "ram", role: Role.Admin, priviledges: [Priviledge.Read, Priviledge.Write] });
getEmp(0);
getEmp(1);
getEmp(2);
